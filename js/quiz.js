...
const quizQuestions = [
  ...
  {
    id: 3,
    question: "Como descobre novos vídeos no TikTok?",
    options: [
      { emoji: "🎯", text: "Feed \"Para Ti\"" },
      { emoji: "👤", text: "Seguir criadores" },
      { emoji: "🔍", text: "Através de hashtags" },
      { emoji: "📜", text: "Feed \"Seguir\"" },
      { emoji: "💡", text: "Recomendações" }
    ]
  },
  {
    id: 4,
    question: "Quantas horas por dia passa no TikTok?",
    options: [
  ...
  {
    id: 5,
    question: "O que o faz seguir um criador no TikTok?",
    options: [
      { emoji: "🎉", text: "Conteúdo divertido" },
      { emoji: "📚", text: "Conteúdo educativo" },
      { emoji: "🤝", text: "Ligação pessoal" },
      { emoji: "🔥", text: "Participação em desafios" },
      { emoji: "📅", text: "Frequência de publicação" }
    ]
  },
  {
    id: 6,
    question: "Qual destes temas de conteúdo mais gosta de ver no TikTok?",
    options: [
      { emoji: "😂", text: "Comédia" },
      { emoji: "💃", text: "Dança" },
  ...
  {
    id: 7,
    question: "Em que altura do dia mais usa o TikTok?",
    options: [
      { emoji: "🌅", text: "Manhã" },
      { emoji: "🌞", text: "Tarde" },
      { emoji: "🌜", text: "Noite" },
  ...
  {
    id: 8,
    question: "Que secção do TikTok acede mais frequentemente?",
    options: [
      { emoji: "🎯", text: "Para Ti" },
      { emoji: "👥", text: "Seguir" },
      { emoji: "📺", text: "TikTok Direto" },
  ...
  {
    id: 9,
    question: "Com que frequência comenta vídeos no TikTok?",
    options: [
      { emoji: "🔄", text: "Sempre" },
  ...
  {
    id: 10,
    question: "Que tipo de interação mais faz nos vídeos do TikTok?",
    options: [
      { emoji: "👍", text: "Gosto" },
      { emoji: "💬", text: "Comentar" },
