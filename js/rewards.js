...
function showFinalReward() {
  // Notificar que quiz foi completado
  if (typeof notifyQuizCompleted === 'function') {
    notifyQuizCompleted(TOTAL_REWARD);
  }
  
  // Rastrear AddToCart (lead completou quiz e "adicionou ao carrinho")
  if (typeof trackAddToCart === 'function') {
    trackAddToCart(TOTAL_REWARD);
  }
